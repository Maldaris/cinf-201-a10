...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2016-11-14 22:58:37',NULL),('diagnostics.include_raw','OFF','2016-11-14 22:58:37',NULL),('ps_thread_trx_info.max_length','65535','2016-11-14 22:58:37',NULL),('statement_performance_analyzer.limit','100','2016-11-14 22:58:37',NULL),('statement_performance_analyzer.view',NULL,'2016-11-14 22:58:37',NULL),('statement_truncate_len','64','2016-11-14 22:58:37',NULL);
...
--
-- Current Database: `cinf-201-a10`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `cinf-201-a10` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `friends` (
  ...
  KEY `fk_user_f1_idx` (`f1`),
  KEY `fk_user_f2_idx` (`f2`),
  CONSTRAINT `fk_user_f1` FOREIGN KEY (`f1`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_f2` FOREIGN KEY (`f2`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `hpass` varchar(45) NOT NULL,
  `userscol` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `hpass_UNIQUE` (`hpass`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-14 23:49:52
